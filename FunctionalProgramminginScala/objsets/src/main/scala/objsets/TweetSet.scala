...
abstract class TweetSet {
  ...
  def includeWord(keyWords: List[String]): TweetSet =
    filter(x => keyWords.exists(word => x.text.contains(word)))
...
//      def rightMost = right.mostRetweeted
//      def leftMost = left.mostRetweeted
//      if(rightMost.retweets > leftMost.retweets && rightMost.retweets > elem.retweets) rightMost
//      else if(leftMost.retweets > rightMost.retweets && leftMost.retweets > elem.retweets) leftMost
//      else elem
//    }
...
object GoogleVsApple {
  ...
  lazy val googleTweets: TweetSet = allTweets.includeWord(google)
  lazy val appleTweets: TweetSet = allTweets.includeWord(apple)
